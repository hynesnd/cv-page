...
var $author$project$Main$ViewingAbout = {$: 'ViewingAbout'};
var $author$project$Main$init = {state: $author$project$Main$ViewingAbout};
...
var $author$project$Main$ViewingCV = {$: 'ViewingCV'};
var $author$project$Main$ViewingPortfolio = {$: 'ViewingPortfolio'};
	...
	function (msg, model) {
		switch (msg.$) {
			case 'ViewCV':
				return _Utils_update(
					model,
					{state: $author$project$Main$ViewingCV});
			case 'ViewAbout':
				return _Utils_update(
					model,
					{state: $author$project$Main$ViewingAbout});
			default:
				return _Utils_update(
					model,
					{state: $author$project$Main$ViewingPortfolio});
		}
	});
...
var $author$project$Colors$black = A3($mdgriffith$elm_ui$Element$rgb255, 23, 23, 23);
var $author$project$Colors$darkGrey = A3($mdgriffith$elm_ui$Element$rgb255, 68, 68, 68);
...
var $author$project$Colors$ffLrBlue = A3($mdgriffith$elm_ui$Element$rgb255, 0, 0, 32);
var $author$project$Colors$ffUlBlue = A3($mdgriffith$elm_ui$Element$rgb255, 0, 0, 176);
...
var $author$project$Main$headshotRow = A2(
	...
	_List_fromArray(
		[
			...
			A2(
				...
				{description: 'A picture of Neil Hynes, the site owner', src: 'Headshot.jpg'})),
			A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$el,
					_List_Nil,
					$mdgriffith$elm_ui$Element$text('Neil Hynes')),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$el,
							_List_Nil,
							$mdgriffith$elm_ui$Element$text('31'))
						])),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
										...
										[
											$mdgriffith$elm_ui$Element$Background$gradient(
											{
												...
												steps: _List_fromArray(
													[$author$project$Colors$ffUlBlue, $author$project$Colors$offWhite])
											}),
											$mdgriffith$elm_ui$Element$height(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$text('MP')),
							A2(
							$mdgriffith$elm_ui$Element$column,
							_List_Nil,
							_List_fromArray(
									...
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$Background$gradient(
											{
												angle: 1,
												steps: _List_fromArray(
													[$author$project$Colors$aquamarine, $author$project$Colors$offWhite])
											}),
											$mdgriffith$elm_ui$Element$height(
											$mdgriffith$elm_ui$Element$px(2)),
											$mdgriffith$elm_ui$Element$width(
...
var $author$project$Main$mainPanel = A2(
	$mdgriffith$elm_ui$Element$column,
	_List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Element$Background$gradient(
			{
				angle: 2.14,
				steps: _List_fromArray(
					[$author$project$Colors$ffUlBlue, $author$project$Colors$ffLrBlue])
			}),
			...
			$mdgriffith$elm_ui$Element$Font$color($author$project$Colors$offWhite),
			$mdgriffith$elm_ui$Element$Font$size(25)
		]),
	_List_fromArray(
		[$author$project$Main$headshotRow]));
var $author$project$Main$ffMenu = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
...
var $author$project$Main$menuColumn = A2(
	$mdgriffith$elm_ui$Element$column,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$alignRight,
		...
		[
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$el,
					_List_Nil,
					$mdgriffith$elm_ui$Element$text('Magic')),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_Nil,
					$mdgriffith$elm_ui$Element$text('Materia')),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_Nil,
					...
					$mdgriffith$elm_ui$Element$el,
					_List_Nil,
					$mdgriffith$elm_ui$Element$text('Limit')),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_Nil,
					$mdgriffith$elm_ui$Element$text('Config')),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_Nil,
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$alignRight]),
							$mdgriffith$elm_ui$Element$text('00:44:37'))
						])),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$alignLeft]),
							$mdgriffith$elm_ui$Element$text('Gil')),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$alignRight]),
							$mdgriffith$elm_ui$Element$text('350'))
						]))
				])),
			A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$alignBottom,
					$mdgriffith$elm_ui$Element$width(
					$mdgriffith$elm_ui$Element$px(375)),
					$mdgriffith$elm_ui$Element$spacing(4),
					A2($mdgriffith$elm_ui$Element$paddingXY, 5, 10),
					$mdgriffith$elm_ui$Element$Font$color($author$project$Colors$offWhite),
					$mdgriffith$elm_ui$Element$Font$size(25)
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[$mdgriffith$elm_ui$Element$alignLeft]),
					$mdgriffith$elm_ui$Element$text('Manchester, UK'))
				]))
		]));
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$gradient(
				{
					angle: 2.14,
					steps: _List_fromArray(
						[$author$project$Colors$black, $author$project$Colors$darkGrey])
				}),
				$mdgriffith$elm_ui$Element$inFront($author$project$Main$menuColumn)
			]),
		$author$project$Main$ffMenu(model));
};
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Main$init, update: $author$project$Main$update, view: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"ViewAbout":[],"ViewCV":[],"ViewPortfolio":[]}}}}})}});
